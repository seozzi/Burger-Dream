...
IL_0042:
	{
		...
		bool L_11;
		L_11 = Nullable_1_Equals_m39505D12D8C20E6821F8D24B7F7EBA377FBE47AA((&V_2), L_10, il2cpp_rgctx_method(method->rgctx_data, 3));
		if (!L_11)
		{
			goto IL_0061;
		}
...
IL_0042:
	{
		...
		RuntimeObject* L_7 = Box(il2cpp_rgctx_data_no_init(method->rgctx_data, 2), &L_6);
		Il2CppFakeBox<Slot_t94C146BFC436F8AA56ADBB63A626E2D70C09FAC4> L_8(il2cpp_rgctx_data_no_init(method->rgctx_data, 2), V_2);
		bool L_9;
		L_9 = ValueType_Equals_mCA5344597A8055EC544855AD60A983B10E0EE67D((ValueType_t6D9B272BD21782F0A9A14F2E41F85A50E97A986F*)(&L_8), L_7, NULL);
		if (!L_9)
		{
